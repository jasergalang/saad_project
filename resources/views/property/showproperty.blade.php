...
<div class="container p-6 bg-white">
        ...
        <div class="col-span-1 bg-white px-4 pb-6 shadow rounded overflow-hidden">
            <div class="divide-y divide-gray-200 space-y-5">
                ...
                {{-- price filter --}}
                    <div class="pt-4">
                        <h3 id="price-id" class="text-xl text-gray-800 mb-3 uppercase font-medium">Price</h3>
                        <div class="mt-4 flex items-center">
                ...
                {{-- Floor Area filter --}}
                <div class="pt-4">
                    <h3 id="floor-id" class="text-xl text-gray-800 mb-3 uppercase font-medium">Floor Area</h3>
                    <div class="mt-4 flex items-center">
